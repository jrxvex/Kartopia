...
import { isTouchPrimary } from '../../input/TouchControls.js';
...
export class TitleScreen extends Screen {
  ...
  build() {
    ...
    this.el.append(
      h(
        ...
        h('div.press-start.focusable', { 'data-default': '1', onClick: () => this.start(), tabindex: '0' }, isTouchPrimary() ? 'Toca la pantalla para empezar' : 'Pulsa cualquier tecla o haz clic para empezar'),
  ...
  start() {
    ...
    this.started = true;
    if (isTouchPrimary()) this.game.requestFullscreen();
